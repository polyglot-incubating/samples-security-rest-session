...
public final class ConverterUtils {
    ...
    public static String getFormattedString(final String format, final Date date) {
        final LocalDateTime dtm = LocalDateTime.ofInstant(date.toInstant(),
     ...
     */
    static public Map<String, Object> toMap(Object bean) throws Exception {
    ...
    static public <T> T toBeanInstance(Map<String, Object> row, Class<T> clazz)
            throws Exception {
        try {
            return toBean(row, clazz);
        }
    ...
    static public <T> T toBean(Map<String, Object> row, Class<T> clazz) throws Exception {
        ...
        try {
            ...
            for (PropertyDescriptor desc : props) {
                ...
                // System.out.printf( "\nname : %s snakeCase: %s value: %s", name,
                // toSnakeCase( name ),
                // value );
                Method setter = desc.getWriteMethod();
    ...
    /**
     * List&#60;Map&#60;K, V&#62;&#62; 리스트 컬렉션 객체를 파라미터로 선언된 클래스 타입 &#60;T&#62;를 통해 리스트
     * 컬렉션 List&#60;T&#62;로 변환 한다.
     *

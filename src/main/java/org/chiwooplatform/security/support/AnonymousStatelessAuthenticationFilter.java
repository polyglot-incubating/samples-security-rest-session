...
public class AnonymousStatelessAuthenticationFilter
    ...
    private static final List<GrantedAuthority> AUTHORITIES = AuthorityUtils
    ...
    protected Authentication createAuthentication(HttpServletRequest request) {
        AnonymousAuthenticationToken auth = new AnonymousAuthenticationToken(key,
                AnonymousStatelessAuthenticationFilter.principal,
                AnonymousStatelessAuthenticationFilter.AUTHORITIES);

...
public class SimpleTest {
    ...
    static Date localDateTimeToUtc(LocalDateTime localDateTime) {
        return Date.from(localDateTime.atZone(ZoneId.systemDefault()).withZoneSameInstant(ZoneId.of("UTC"))
    ...
    static long getMinutesTime(LocalDateTime start, LocalDateTime end) {
        LocalDateTime today = LocalDateTime.of(start.getYear(), start.getMonthValue(), start.getDayOfMonth(),
